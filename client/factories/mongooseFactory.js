myApp.factory('mongooseFactory', function($http){
	...
	factory.deleteMongoose = function(deleteMongoose, callback){
		$http.get('/mongoose/' + deleteMongoose + '/delete', deleteMongoose).then(function(data){
			console.log('this is delete facotry and who knows what is sent here', data.data);
			// callback(data.data);
		})
	}
